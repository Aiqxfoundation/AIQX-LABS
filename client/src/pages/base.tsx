...
export default function Base() {
  ...
  const deployMutation = useMutation({
    mutationFn: async (data: EvmTokenCreationForm) => {
      ...
      try {
        const response = await apiRequest("POST", "/api/tokens/deploy", {
          ...data,
          chainId: data.chainId || 'base-testnet',
          blockchainType: "EVM",
    ...
    onSuccess: (data) => {
      toast({
        title: "Base Token Deployed Successfully!",
  ...
  return (
    <div className="container max-w-5xl py-12 px-4">
      <div className="mb-8 flex items-center gap-4">
        <div className="h-16 w-16 rounded-full bg-gradient-to-br from-blue-600 to-blue-700 p-0.5">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Deploy your custom token on Base Mainnet or Sepolia Testnet
          </p>
        </div>
      </div>

      {!isConnected && (
        <Card className="mb-6 border-2 border-blue-600/20 bg-gradient-to-br from-blue-600/5 to-blue-700/5">
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                data-testid="button-connect-base-wallet"
              >
      ...
      <TokenCreationFormComponent
        ...
        defaultChainId="base-testnet"
        allowedChainIds={['base-mainnet', 'base-testnet']}
      />
    </div>
  );
}
