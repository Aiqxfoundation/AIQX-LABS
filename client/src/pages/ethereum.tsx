...
export default function Ethereum() {
  ...
  const deployMutation = useMutation({
    mutationFn: async (data: EvmTokenCreationForm) => {
      ...
      try {
        const response = await apiRequest("POST", "/api/tokens/deploy", {
          ...data,
          chainId: data.chainId || 'ethereum-testnet',
          blockchainType: "EVM",
    ...
    onSuccess: (data) => {
      toast({
        title: "Ethereum Token Deployed Successfully!",
  ...
  return (
    <div className="container max-w-5xl py-12 px-4">
      <div className="mb-8 flex items-center gap-4">
        <div className="h-16 w-16 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 p-0.5">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Deploy your custom ERC20 token on Ethereum Mainnet or Sepolia Testnet
          </p>
        </div>
      </div>

      {!isConnected && (
        <Card className="mb-6 border-2 border-blue-500/20 bg-gradient-to-br from-blue-500/5 to-blue-600/5">
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                data-testid="button-connect-ethereum-wallet"
              >
      ...
      <TokenCreationFormComponent
        ...
        defaultChainId="ethereum-testnet"
        allowedChainIds={['ethereum-mainnet', 'ethereum-testnet']}
      />
    </div>
  );
}
